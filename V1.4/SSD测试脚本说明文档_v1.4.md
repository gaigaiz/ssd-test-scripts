...
本脚本面向 Linux (Ubuntu) 平台下的 SSD 测试工程师，覆盖以下七大测试项目：
...
| 7 | 操作系统中断测试 | OS Interruption Test | 验证SSD在持续I/O期间S3/S4休眠/唤醒的稳定性与数据完整性，循环检查磁盘标识/分区/数据，长期循环验证 |
